...
function toggleSubmitBtn (current_title, current_content, wordCount) {
...
component('blogEntryEdit', {
  ...
  function BlogEntryEditController($routeParams, BlogEntryDetail) {
    ...
    this.updateBlogEntryFunc = function() {
      ...
      BlogEntryDetail.update({id: this.id}, this.detailedBlogEntry);
    }

    this.wordCount = 0;

    this.keyUpHandler = function() {
      toggleSubmitBtn(this.editBlogEntryTitle,
                      this.editBlogEntryText,
                      getTinyMceWordCount());
    }
    ...
    this.tinymceOptions = {
      setup: function (editor) {
        ...
        editor.on('keyup', function (e) {
          ...
          viewModel.wordCount = getTinyMceWordCount();

          toggleSubmitBtn(viewModel.editBlogEntryTitle, current_content, viewModel.wordCount);
        });
      },
      height: '450',
